...
// servis icon
export const AiBrainIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Brain {...props} />
);
...
export const TimeSeriesIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <LineChart {...props} />
);
...
export const WebAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <Globe {...props} />
);
...
export const NextjsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 15V9l7.7 10.5A9 9 0 1 1 2.3 12.3"></path>
...
export const JavaScriptIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M10 9a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1Z"></path>
    </svg>
);
...
export const HelpfulTipsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="M12 8v4l3 3"/><path d="m8 2.5-3 3"/><path d="m16 2.5 3 3"/></svg>
);
